...
export const UI_CONTRACT = {
  ...
  'orchestra.js': ['catalog_apply','catalog_get','catalog_list','catalog_preview','catalog_status','health_matrix_get','orchestra_apply_best','orchestra_apply_status','orchestra_auto_disable','orchestra_auto_enable','orchestra_auto_restore','orchestra_auto_run','orchestra_auto_status','orchestra_auto_stop','orchestra_capabilities','orchestra_events','orchestra_history','orchestra_preview_best','orchestra_probe_preflight','orchestra_ratings_get','orchestra_restore_previous','orchestra_run_continue','orchestra_run_history','orchestra_run_pause','orchestra_run_resume','orchestra_run_start','orchestra_run_status','orchestra_run_stop','orchestra_status','status'],
