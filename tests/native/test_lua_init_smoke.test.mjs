...
test('required Z2K/manager Lua functions are defined in the manifest baseline set', () => {
	...
	// runtime-assets and every required current runtime function
	// must be defined there — a missing definition would make the installed
	// runtime unsatisfiable and Z2K could never reach ready.
