...
test('Task 5: Engine package upgrade/rollback invariants and single-writer control', () => {
  ...
  const makefile = path.resolve('zapret2-manager-full/Makefile');
  ...
  assert.match(makeContent, /PKG_NAME:=zapret2-manager-full/, 'Package name must be zapret2-manager-full');
