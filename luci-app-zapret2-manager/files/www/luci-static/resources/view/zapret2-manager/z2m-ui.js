...
(function () {
	...
	Z2M.ui = {
		...
		SummaryPanel: function (options) { options = options || {}; var body = Array.isArray(options.children) ? E('div', {}, options.children) : options.children || E('div', {}); return E('section', { 'class': 'z2m-remastered-summary' }, [options.title ? E('h3', {}, safe_text(options.title, 120)) : E('span', {}), body]); },
		...
		DetailsDisclosure: function (options) { options = options || {}; var body = Array.isArray(options.content) ? E('div', {}, options.content) : options.content || E('div', {}); return E('details', { 'class': 'z2m-remastered-details' }, [E('summary', {}, safe_text(options.title || tr('Details'), 120)), body]); },
