...
pause_watchdog
phase verifying 45 'Проверяется payload official release.'; mkdir "$WORK/unpack" || fail EARCHIVE 'Не удалось создать каталог распаковки.'
