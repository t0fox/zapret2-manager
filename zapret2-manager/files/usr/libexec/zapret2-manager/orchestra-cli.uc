...
import { orchestra_capabilities, orchestra_status, orchestra_events, orchestra_history } from './orchestra.uc';
...
if (mode == 'capabilities') {
	...
	print('usage: ucode orchestra-cli.uc capabilities | status | events | history\n');
	exit(1);
}
