...
else { print('usage: tg-product-cli.uc get|catalog|status|validate|preview|apply|health|check_updates|switch|install|update|remove|purge|start|stop|restart [input]\n'); exit(1); }
