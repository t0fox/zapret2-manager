...
import { resource_center_status, resource_center_status_summary, resource_center_check, resource_center_update, resource_center_prepare_version, resource_center_enqueue_update, resource_center_enqueue_prepare, resource_center_update_status, resource_center_recover_pending } from './resource-update.uc';
...
else if (mode == 'status-summary') result = resource_center_status_summary();
