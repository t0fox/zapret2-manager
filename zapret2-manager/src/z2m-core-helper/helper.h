...
int z2m_atomic_write(const struct z2m_request *request, const struct z2m_root *root, int root_fd);
int z2m_atomic_write_json(const struct z2m_request *request, const struct z2m_root *root, int root_fd);
