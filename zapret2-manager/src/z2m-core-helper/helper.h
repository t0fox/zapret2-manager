...
#define Z2M_JSON_MAX_KEYS 4096U
#define Z2M_JSON_MAX_CONTAINERS 2048U
#define Z2M_CANONICAL_MAX_DEPTH 64U
#define Z2M_CANONICAL_MAX_CONTAINERS 2048U
#define Z2M_CANONICAL_MAX_MEMBERS 4096U
#define Z2M_CANONICAL_MAX_NODES 131072U
...
int z2m_scanner_probe(const struct z2m_request *request) __attribute__((weak));
