...
- [x] **Step 1: Confirm checkout and source baseline**
...
- [x] **Step 2: Run the focused baseline suite**
...
- [x] **Step 1: Add the v2 installed closure RED test**
...
- [x] **Step 2: Add authority and candidate RED tests**
...
- [x] **Step 3: Add V1 capability and migration RED tests**
...
- [x] **Step 4: Add resolution-versus-verification RED tests**
...
- [x] **Step 5: Run only the new tests and record RED**
...
- [x] **Step 1: Implement normalized entry validation**
...
- [x] **Step 2: Implement ordered subsets without a provider map**
...
- [x] **Step 3: Implement `resolveInstalled()`**
...
- [x] **Step 4: Implement `resolveCandidate(preparedTarget)`**
...
- [x] **Step 5: Implement the three verification functions**
...
- [x] **Step 6: Implement the explicit CLI/runtime-sync boundary**
...
- [x] **Step 7: Run the resolver suite green**
...
- [x] **Step 8: Commit the pure resolver slice**
...
- [x] **Step 1: Write RED assertions for two-phase promotion**
...
- [x] **Step 2: Specify the v2 receipt serialization for the Task 4 slice**
...
- [x] **Step 3: Specify explicit V1 state**
...
- [x] **Step 4: Prove mutable classification cannot invent V1 composition**
...
- [x] **Step 5: Validate the RED inputs for Task 4**
...
- [x] **Step 1: Add RED tests for the durable journal boundary**
...
- [x] **Step 2: Add RED tests for revision semantics**
...
- [x] **Step 3: Implement durable phase persistence**
...
- [x] **Step 4: Rewire prepare/apply to the canonical candidate**
...
- [x] **Step 5: Implement same-release V1 reconciliation through `reinstall`**
...
- [x] **Step 6: Remove Z2K direct-fetch bypasses**
...
- [x] **Step 7: Implement boot recovery entry point**
...
- [x] **Step 8: Preserve pure local post-mutation CHECK_STATE reconciliation**
...
- [x] **Step 9: Run transaction tests green**
...
- [x] **Step 10: Commit lifecycle transaction slice**
...
- [x] **Step 1: Add RED test for static-list removal**
...
- [x] **Step 2: Implement resolver-driven materialization**
...
- [x] **Step 3: Separate activation from steady-state process checks**
...
- [x] **Step 4: Run materialization and proof tests green**
...
- [x] **Step 5: Commit runtime proof slice**
...
- [x] **Step 1: Add RED test for exact native closure**
...
- [x] **Step 2: Add RED Strategy Apply CAS test**
...
- [x] **Step 3: Implement server-owned Strategy snapshot sequence**
...
- [x] **Step 4: Implement scanner overlay boundary**
...
- [x] **Step 5: Remove dynamic Lua list from preflight manifest**
...
- [x] **Step 7: Commit consumer migration slice**
...
- [x] **Step 1: Add RED resurrection tests**
...
- [x] **Step 2: Add RED direct-fetch audit**
...
- [x] **Step 3: Run ownership and clean-install tests green**
...
- [x] **Step 4: Commit ownership/regression slice**
...
- [x] **Step 1: Run all product tests serially**
...
- [x] **Step 3: Perform source-level direct-fetch and authority audit**
...
- [x] **Step 1: Capture initial authority**
