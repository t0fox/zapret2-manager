...
«Не проверено». Для Engine upstream release показывается только при наличии
подтверждённой authority; package metadata остаётся отдельным техническим полем.
