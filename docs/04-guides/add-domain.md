---
id: public-guide-add-domain
title: "Как добавить домен вручную"
type: guide
status: current
...
# Как добавить домен вручную

Откройте **Сервисы и домены → Мои домены**, добавьте домен в поддерживаемом
