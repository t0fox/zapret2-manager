---
id: knowledge-home
title: "zapret2-manager Knowledge Home"
type: home
status: current
authority: index
updated: 2026-08-13
...
- [Contracts](./04-contracts/index.md)
- [Parity](./05-parity/index.md)
- [Upstreams](./06-upstreams/index.md)
- [Decisions](./07-decisions/index.md)
- [Development](./08-development/index.md)
- [Work](./09-work/index.md)
- [Research](./10-research/index.md)
- [Operations](./11-operations/index.md)
- [AI entry point](./12-ai/ai-entry-point.md)
...
Internal state, work notes, operations, and AI contracts remain in the vault but are intentionally not published here.
