...
const CODE_EVIDENCE = {
  ...
  'docs/03-products/scanner-runtime.md': [{ path: 'zapret2-manager/files/usr/libexec/zapret2-manager/scanner-cli.uc', start: 32, end: 56, symbol: 'scanner_cli_dispatch', why: 'Совместимый CLI-слой направляет все Scanner-действия только в типизированный Z2K Detect и его canonical errors.' }],
  ...
  'docs/08-development/scanner-architecture.md': [{ path: 'zapret2-manager/files/usr/libexec/zapret2-manager/z2k-detect.uc', start: 248, end: 267, symbol: 'z2k_detect_status_normalize', why: 'Typed Detect status принимает только coherent release, binary digest, architecture и runtime compatibility identity из canonical authority.' }],
