...
const CODE_EVIDENCE = {
  ...
  'docs/08-development/apk-build.md': [{ path: '.github/workflows/apk-build.yml', start: 1, end: 44, symbol: 'OpenWrt APK build', why: 'Единственный автоматизированный workflow собирает и проверяет три manager APK, затем публикует единый rolling main-latest bundle.' }],
