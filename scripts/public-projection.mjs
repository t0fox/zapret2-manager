...
const CODE_EVIDENCE = {
  ...
  'docs/08-development/architecture.md': [{ path: 'luci-app-zapret2-manager/files/www/luci-static/resources/view/zapret2-manager/z2m-navigation-system.js', start: 9, end: 63, symbol: 'GROUPS', why: 'Единый navigation source задаёт пользовательские группы и владельцев страниц.' }],
