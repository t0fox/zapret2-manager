...
# P02-only direct SCP deployment. Frozen Avatar donor:
# avatarDD/zapret-gui main @ 38ed85ce487c6b3dbdf703a5be197795f7c0cad1
ROOT=${ROOT:-$(CDPATH= cd -- "${0%/*}/.." && pwd)}
TARGET=${TARGET:-root@192.168.1.1}
REMOTE_ROOT=${REMOTE_ROOT:-/tmp/z2m-control-parity}
BACKUP_ROOT=${BACKUP_ROOT:-$REMOTE_ROOT/backup}
SSH_CONNECT_TIMEOUT=${SSH_CONNECT_TIMEOUT:-5}
EXPECTED_COMMIT=${EXPECTED_COMMIT:-}

[ "${CONFIRM_TARGET_DEPLOY:-}" = CONTROL_ONLY ] || {
    printf '%s\n' 'Refusing target mutation. Set CONFIRM_TARGET_DEPLOY=CONTROL_ONLY.' >&2
    exit 2
}
[ -n "$EXPECTED_COMMIT" ] || {
    printf '%s\n' 'Refusing target mutation. Set EXPECTED_COMMIT to the committed P02 HEAD.' >&2
    exit 2
}
if [ -f "$ROOT/.git" ]; then
...
luci-app-zapret2-manager/files/www/luci-static/resources/view/zapret2-manager/z2m-avatar-control.js|/www/luci-static/resources/view/zapret2-manager/z2m-avatar-control.js
luci-app-zapret2-manager/files/www/luci-static/resources/view/zapret2-manager/z2m-control-model.js|/www/luci-static/resources/view/zapret2-manager/z2m-control-model.js
...
luci-app-zapret2-manager/files/www/luci-static/resources/view/zapret2-manager/z2m-format.js|/www/luci-static/resources/view/zapret2-manager/z2m-format.js
...
luci-app-zapret2-manager/files/www/luci-static/resources/view/zapret2-manager/z2m-avatar-ui.css|/www/luci-static/resources/view/zapret2-manager/z2m-avatar-ui.css
'
...
printf 'Deployed P02 Control commit %s; donor 38ed85ce487c6b3dbdf703a5be197795f7c0cad1; backup: %s\n' "$EXPECTED_COMMIT" "$BACKUP_ROOT"
